...
set_secret USAJOBS_API_KEY "${USAJOBS_API_KEY:-}"
set_secret TICKETMASTER_API_KEY "${TICKETMASTER_API_KEY:-}"
set_secret AWIN_ACCESS_TOKEN "${AWIN_ACCESS_TOKEN:-}"
...
set_variable USAJOBS_USER_AGENT "${USAJOBS_USER_AGENT:-}"
set_variable AWIN_PUBLISHER_ID "${AWIN_PUBLISHER_ID:-}"
