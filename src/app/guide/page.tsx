...
const guides = [
  {
    ...
    steps: [
      ...
      "Complete onboarding so recommendations use your goals, interests, regions, and preferred opportunity types.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Complete onboarding with your organization name, website, type, and description before submitting supply.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Complete onboarding with your partner organization, contact details, proposed offer, and target audience.",
