...
async function main() {
  ...
  const providers = {
    ...
    microsoftLearn: await prisma.provider.create({
      data: {
    ...
    mitOcw: await prisma.provider.create({
      data: {
    ...
    githubStudentPack: await prisma.provider.create({
      data: {
    ...
    slickdealsEducation: await prisma.provider.create({
      data: {
  ...
  const eventListings = [
    { title: "EdTech World Forum", slug: "edtech-world-forum", type: "event" as const, description: "The world's leading education technology conference. 3 days of keynotes, workshops, and networking with 5,000+ educators and innovators.", url: "https://www.eventbrite.com/e/edtech-world-forum", location: "London, UK", startDate: daysFromNow(35), endDate: daysFromNow(37), price: 499, priceLabel: "From $499", providerId: providers.eventbrite.id, categoryId: cats.teachingLMS.id, externalId: "eb-edtech-forum-demo", tagSlugs: ["professional", "community"] },
    { title: "AI in Education Summit", slug: "ai-education-summit", type: "event" as const, description: "Explore how artificial intelligence is transforming learning. Hands-on workshops on AI tutoring, automated grading, and personalized learning paths.", url: "https://www.eventbrite.com/e/ai-edu-summit", location: "Virtual", startDate: daysFromNow(18), endDate: daysFromNow(19), price: 0, priceLabel: "Free", providerId: providers.eventbrite.id, categoryId: cats.aiStudyTools.id, externalId: "eb-ai-edu-summit-demo", tagSlugs: ["free", "ai-powered", "community", "interactive"] },
    { title: "SXSW EDU", slug: "sxsw-edu", type: "event" as const, description: "Annual education conference and festival in Austin, TX. Sessions on innovation, equity, and the future of learning.", url: "https://www.eventbrite.com/e/sxsw-edu", location: "Austin, TX", startDate: daysFromNow(60), endDate: daysFromNow(63), price: 695, priceLabel: "From $695", providerId: providers.eventbrite.id, categoryId: cats.professionalDev.id, externalId: "eb-sxsw-edu-demo", tagSlugs: ["professional", "community", "interactive"] },
    { title: "Google for Education: Certified Educator Workshop", slug: "google-certified-educator-workshop", type: "event" as const, description: "Free virtual workshop to prepare for Google Certified Educator Level 1 exam. Learn Google Workspace tools for the classroom.", url: "https://www.eventbrite.com/e/google-edu-workshop", location: "Virtual", startDate: daysFromNow(12), endDate: daysFromNow(12), price: 0, priceLabel: "Free", providerId: providers.eventbrite.id, categoryId: cats.teachingLMS.id, externalId: "eb-google-edu-workshop", tagSlugs: ["free", "certificate", "interactive", "beginner-friendly"] },
    { title: "International Literacy Conference", slug: "international-literacy-conference", type: "event" as const, description: "Annual gathering of literacy educators, researchers, and advocates. Workshops on reading instruction, children's literature, and digital literacy.", url: "https://www.eventbrite.com/e/literacy-conf", location: "Nashville, TN", startDate: daysFromNow(45), endDate: daysFromNow(47), price: 350, priceLabel: "From $350", providerId: providers.eventbrite.id, categoryId: cats.booksReading.id, externalId: "eb-literacy-conf-demo", tagSlugs: ["professional", "community", "k-12"] },
  ];
  ...
  // ── Deals ──────────────────────────────────────────
  const deals = [
    { title: "Coursera Plus Annual — 40% Off", slug: "coursera-plus-40-off", description: "Get unlimited access to 7,000+ courses and professional certificates with Coursera Plus. Limited-time 40% discount.", code: "LEARN40", url: "https://www.coursera.org/courseraplus", discount: "40% off", providerName: "Coursera", categorySlug: "online-courses", expiresAt: daysFromNow(90) },
    { title: "Udemy Flash Sale — Courses from $9.99", slug: "udemy-flash-sale-999", description: "Thousands of top-rated courses starting at just $9.99 during Udemy's flash sale event.", url: "https://www.udemy.com", discount: "Up to 90% off", providerName: "Udemy", categorySlug: "online-courses", expiresAt: daysFromNow(45) },
    { title: "Free Month of Skillshare Premium", slug: "skillshare-free-month", description: "Get one full month of Skillshare Premium free. Access thousands of creative classes in design, illustration, and photography.", code: "FREETRIAL", url: "https://www.skillshare.com", discount: "Free month", providerName: "Skillshare", categorySlug: "creative-design", expiresAt: daysFromNow(120) },
    { title: "LinkedIn Learning — Free 1-Month Trial", slug: "linkedin-learning-free-trial", description: "Try LinkedIn Learning free for 1 month. Access 16,000+ business, tech, and creative courses.", url: "https://www.linkedin.com/learning/subscription/free-trial", discount: "Free 1-month trial", providerName: "LinkedIn Learning", categorySlug: "professional-development", expiresAt: daysFromNow(120) },
    { title: "DataCamp — 50% Off Annual Plan", slug: "datacamp-50-off-annual", description: "Learn data science for half price. 50% off DataCamp's annual subscription with access to 400+ courses.", code: "DATA50", url: "https://www.datacamp.com", discount: "50% off", providerName: "DataCamp", categorySlug: "professional-development", expiresAt: daysFromNow(75) },
    { title: "Grammarly Premium — 40% Student Discount", slug: "grammarly-student-discount", description: "Students get 40% off Grammarly Premium. AI-powered writing assistance for essays, research papers, and more.", url: "https://www.grammarly.com/edu", discount: "40% off (students)", providerName: "Grammarly", categorySlug: "writing-research", expiresAt: daysFromNow(120) },
    { title: "Brilliant Premium — 20% Off Annual", slug: "brilliant-20-off-annual", description: "Save 20% on Brilliant Premium annual plan. Interactive STEM courses in math, science, and computer science.", code: "STEM20", url: "https://brilliant.org", discount: "20% off", providerName: "Brilliant", categorySlug: "stem-science", expiresAt: daysFromNow(95) },
    { title: "Duolingo Super — 60% Off Family Plan", slug: "duolingo-super-family-discount", description: "Learn languages together! 60% off Duolingo Super family plan for up to 6 members.", url: "https://www.duolingo.com/super", discount: "60% off family plan", providerName: "Duolingo", categorySlug: "language-learning", expiresAt: daysFromNow(80) },
  ];
